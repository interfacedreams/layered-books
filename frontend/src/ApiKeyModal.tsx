    ...
    >
      <div className="bg-surface border border-line rounded-lg shadow-xl w-full max-w-md mx-4 p-6">
        ...
        <div className="flex gap-2">
          <button
            onClick={handleSave}
            className="flex-1 bg-highlight text-core py-2 px-4 rounded-md hover:bg-highlight/85 cursor-pointer transition-colors font-medium"
          >
            Save
          </button>
          <button
            onClick={handleClear}
            className="px-4 py-2 border border-line rounded-md hover:bg-accent/25 cursor-pointer transition-colors text-muted"
          >
            Clear
          </button>
        </div>
